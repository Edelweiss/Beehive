...
class UpdateSortCommand extends Command
{
    ...
    {
        $this->addOption('editions', InputOption::VALUE_REQUIRED, 'comma separated list of editions whose corrections need an update, such as --editions=2,45,67'); // --editions=2,45,67
    }
